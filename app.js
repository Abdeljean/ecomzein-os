  ...
  modal.innerHTML = `
    <div class="modal-header no-print" style="padding:1rem 1.25rem; border-bottom:1px solid #E2E8F0; display:flex; justify-content:space-between; align-items:center;">
      <h3 style="font-size:1.1rem; color:#1F2937; display:flex; align-items:center; gap:0.5rem;">
        <span style="background:#EFF6FF; color:#2563EB; padding:0.2rem 0.55rem; border-radius:6px; font-weight:800; font-size:0.85rem;">PDF</span>
        Devis Officiel Enterprise #${q.id}
      </h3>
      <button class="icon-btn" onclick="closeModal()"><i data-lucide="x"></i></button>
    </div>
    
    <div class="modal-body" style="padding:1.5rem; background:#F8FAFC; max-height:80vh; overflow-y:auto;">
      
      <!-- PRINTABLE AREA (A4 PAGE TEMPLATE) -->
      <div id="printable-quote-area" style="background:white; border:1px solid #E2E8F0; border-radius:16px; padding:2rem; box-shadow:0 10px 30px rgba(0,0,0,0.05); font-family:'Inter', sans-serif;">
        
        <!-- Header: Logo & Legal Infos -->
        <div style="display:flex; justify-content:space-between; align-items:flex-start; padding-bottom:1.5rem; border-bottom:2px solid #2563EB; margin-bottom:1.5rem;">
          <div>
            <div style="display:flex; align-items:center; gap:0.6rem; margin-bottom:0.4rem;">
              <div style="width:40px; height:40px; border-radius:10px; background:linear-gradient(135deg, #2563EB, #1D4ED8); color:white; font-weight:800; font-size:1.2rem; display:flex; align-items:center; justify-content:center;">EZ</div>
              <div style="font-size:1.4rem; font-weight:800; color:#1F2937; letter-spacing:-0.02em;">Ecom Zein OS</div>
            </div>
          ...
          <div style="text-align:right;">
            <div style="font-size:1.5rem; font-weight:900; color:#1E3A8A; letter-spacing:0.02em; text-transform:uppercase;">DEVIS</div>
            <div style="font-size:1rem; font-weight:800; color:#2563EB; margin-top:0.1rem;">#${q.id}</div>
            <div style="margin-top:0.5rem; background:#EFF6FF; border:1px solid #BFDBFE; padding:0.4rem 0.75rem; border-radius:8px; display:inline-block;">
              <div style="font-size:0.72rem; color:#1E40AF; font-weight:700;">DATE D'ÉMISSION</div>
              <div style="font-size:0.85rem; font-weight:800; color:#1F2937;">${todayStr}</div>
            </div>
            <div style="font-size:0.72rem; color:#EF4444; font-weight:700; margin-top:0.3rem;">Validité: 15 jours (Jusqu'au ${expiryDate})</div>
          </div>
        </div>
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:1.25rem; margin-bottom:1.5rem;">
          <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:12px; padding:1rem;">
            <div style="font-size:0.72rem; font-weight:800; color:#64748B; text-transform:uppercase; letter-spacing:0.05em; margin-bottom:0.4rem;">DESTINATAIRE / CLIENT</div>
            <div style="font-size:1.1rem; font-weight:800; color:#1F2937;">${q.client}</div>
            <div style="font-size:0.82rem; color:#475569; margin-top:0.25rem;">📍 ${q.city || 'Casablanca, Maroc'}</div>
            <div style="font-size:0.82rem; color:#475569;">📞 ${q.phone || '+212 661-009988'}</div>
            <div style="font-size:0.75rem; color:#64748B; margin-top:0.25rem;">Statut Dossier: <span style="color:#16A34A; font-weight:700;">✅ Qualifié / Validé</span></div>
          </div>

          <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:12px; padding:1rem;">
            <div style="font-size:0.72rem; font-weight:800; color:#64748B; text-transform:uppercase; letter-spacing:0.05em; margin-bottom:0.4rem;">RESPONSABLE COMMERCIAL DÉDIÉ</div>
            <div style="font-size:1rem; font-weight:800; color:#1F2937;">${q.salesperson || state.currentUser.name}</div>
            <div style="font-size:0.82rem; color:#475569; margin-top:0.25rem;">📧 ${state.currentUser.email}</div>
            <div style="font-size:0.82rem; color:#475569;">🏛️ Division Solutions Médicales & Enterprise</div>
            <div style="font-size:0.75rem; color:#2563EB; font-weight:700; margin-top:0.25rem;">Garantie Matérielle: 12 Mois Incluses</div>
          </div>
        </div>
        ...
        <table style="width:100%; border-collapse:collapse; margin-bottom:1.5rem; font-size:0.85rem;">
          <thead>
            <tr style="background:#1E293B; color:white; text-align:left;">
              <th style="padding:0.75rem 1rem; border-top-left-radius:8px; border-bottom-left-radius:8px;">Désignation des Équipements & Prestations</th>
              <th style="padding:0.75rem; text-align:center;">Qté</th>
              <th style="padding:0.75rem; text-align:right;">P.U. HT</th>
              <th style="padding:0.75rem; text-align:center;">TVA</th>
              <th style="padding:0.75rem 1rem; text-align:right; border-top-right-radius:8px; border-bottom-right-radius:8px;">Total HT (MAD)</th>
            </tr>
          </thead>
          <tbody>
            <tr style="border-bottom:1px solid #E2E8F0;">
              <td style="padding:0.85rem 1rem;">
                <div style="font-weight:800; color:#1F2937; font-size:0.92rem;">${q.pack}</div>
                <div style="font-size:0.78rem; color:#64748B; margin-top:0.2rem; line-height:1.35;">
                  • Écran/Borne Tactile HD Qualité Médicale & Distributeur de Tickets Thermique<br>
                  • Licence Logiciel Ecom Zein Queue Enterprise (Serveur Local Inclus)<br>
                  • Câblage IP, Installation Technique, Paramétrage & Formation du Personnel
                </div>
              </td>
              <td style="padding:0.85rem; text-align:center; font-weight:700;">1</td>
              <td style="padding:0.85rem; text-align:right; font-weight:700;">${totalHT.toLocaleString()}</td>
              <td style="padding:0.85rem; text-align:center; font-weight:600; color:#64748B;">20%</td>
              <td style="padding:0.85rem 1rem; text-align:right; font-weight:800; color:#1F2937;">${totalHT.toLocaleString()}</td>
            </tr>
            <tr style="border-bottom:1px solid #E2E8F0; background:#F8FAFC;">
              <td style="padding:0.65rem 1rem;">
                <div style="font-weight:700; color:#334155; font-size:0.82rem;">🛡️ Pack Garantie & Support Technique Dédié</div>
                <div style="font-size:0.75rem; color:#64748B;">Support 7j/7, Échange Matériel à Neuf & Assistance à Distance</div>
              </td>
              <td style="padding:0.65rem; text-align:center; font-weight:700;">1</td>
              <td style="padding:0.65rem; text-align:right; font-weight:700; color:#16A34A;">Inclus</td>
              <td style="padding:0.65rem; text-align:center; font-weight:600;">20%</td>
              <td style="padding:0.65rem 1rem; text-align:right; font-weight:800; color:#16A34A;">0 MAD</td>
            </tr>
          </tbody>
        </table>
        ...
        <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:1.5rem;">
          <div style="width:55%; background:#EFF6FF; border:1px solid #BFDBFE; border-radius:12px; padding:1rem;">
            ...
            <div style="font-size:0.8rem; color:#1E3A8A; line-height:1.45;">
              ...
              • <b>Solde à l'installation / livraison (50%):</b> ${soldeVal.toLocaleString()} MAD TTC<br>
              • Mode de règlement: Virement Bancaire ou Chèque à l'ordre de <b>Ecom Zein Maroc</b>.<br>
              • RIB Bancaire: <b>011 780 0000123456789012 45 (Attijariwafa Bank)</b>
            </div>
          </div>

          <div style="width:40%; background:#F8FAFC; border:1px solid #CBD5E1; border-radius:12px; padding:1rem; text-align:right;">
            ...
            <div style="display:flex; justify-content:space-between; margin-bottom:0.6rem; font-size:0.85rem; color:#475569;">
              <span>TVA (20%):</span>
              <span style="font-weight:700; color:#1F2937;">${tvaVal.toLocaleString()} MAD</span>
            </div>
            <div style="border-top:2px solid #2563EB; padding-top:0.5rem; display:flex; justify-content:space-between; font-size:1.15rem; font-weight:900; color:#1E3A8A;">
              <span>TOTAL TTC:</span>
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:0.75rem; margin-bottom:1.5rem;">
          <div style="border:1px solid #E2E8F0; border-radius:10px; padding:0.6rem 0.8rem; text-align:center; background:#F8FAFC;">
            <div style="font-size:1.1rem;">🛡️</div>
            <div style="font-weight:800; font-size:0.78rem; color:#1F2937; margin-top:0.2rem;">Garantie 12 Mois</div>
            <div style="font-size:0.7rem; color:#64748B;">Échange à neuf en cas de panne</div>
          </div>
          <div style="border:1px solid #E2E8F0; border-radius:10px; padding:0.6rem 0.8rem; text-align:center; background:#F8FAFC;">
            <div style="font-size:1.1rem;">⚡</div>
            <div style="font-weight:800; font-size:0.78rem; color:#1F2937; margin-top:0.2rem;">Installation Inclus</div>
            <div style="font-size:0.7rem; color:#64748B;">Prise en charge technique complète</div>
          </div>
          <div style="border:1px solid #E2E8F0; border-radius:10px; padding:0.6rem 0.8rem; text-align:center; background:#F8FAFC;">
            <div style="font-size:1.1rem;">🎓</div>
            <div style="font-weight:800; font-size:0.78rem; color:#1F2937; margin-top:0.2rem;">Formation du Personnel</div>
            <div style="font-size:0.7rem; color:#64748B;">Support & assistance d'équipe</div>
          </div>
        </div>
        ...
        <div style="display:flex; justify-content:space-between; align-items:flex-end; padding-top:1rem; border-top:1px dashed #CBD5E1;">
          <div style="width:45%; text-align:center; border:1px dashed #CBD5E1; border-radius:10px; padding:0.85rem; height:90px; display:flex; flex-direction:column; justify-content:space-between;">
            <div style="font-size:0.72rem; font-weight:800; color:#64748B; text-transform:uppercase;">BON POUR ACCORD & CACHET CLIENT</div>
            <div style="font-size:0.7rem; color:#94A3B8;">Mention "Lu et approuvé" + Signature</div>
          </div>

          <div style="width:45%; text-align:center; border:1px solid #BFDBFE; background:#EFF6FF; border-radius:10px; padding:0.85rem; height:90px; display:flex; flex-direction:column; justify-content:space-between;">
            <div style="font-size:0.72rem; font-weight:800; color:#1E40AF; text-transform:uppercase;">POUR ECOM ZEIN MAROC S.A.R.L</div>
            <div style="font-size:0.8rem; font-weight:800; color:#1E3A8A; letter-spacing:0.05em;">[ CACHET & SIGNATURE OFFICIELLE ]</div>
          </div>
        </div>
