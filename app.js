...
function openQuoteModal(quoteId) {
  ...
  modal.innerHTML = `
    ...
    <div class="modal-body" style="padding:1.25rem; background:#F8FAFC; max-height:85vh; overflow-y:auto;">
      ...
      <!-- PRINTABLE AREA (PERFECT SINGLE-PAGE A4 FIT) -->
      <div id="printable-quote-area" style="background:white; border:1px solid #CBD5E1; border-radius:12px; padding:1.5rem 1.75rem; box-shadow:0 10px 30px rgba(0,0,0,0.04); font-family:'Inter', sans-serif; box-sizing:border-box; min-height:760px; max-height:790px; display:flex; flex-direction:column; justify-content:space-between; page-break-inside:avoid; break-inside:avoid;">
        ...
        <div>
          ...
          <div style="display:flex; justify-content:space-between; align-items:flex-start; padding-bottom:1rem; border-bottom:2px solid #2563EB; margin-bottom:1rem;">
            <div>
              <div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:0.3rem;">
                <div style="width:36px; height:36px; border-radius:8px; background:linear-gradient(135deg, #2563EB, #1D4ED8); color:white; font-weight:800; font-size:1.1rem; display:flex; align-items:center; justify-content:center;">EZ</div>
                <div style="font-size:1.35rem; font-weight:800; color:#1E293B; letter-spacing:-0.02em;">Ecom Zein OS</div>
              </div>
              <div style="font-size:0.78rem; font-weight:700; color:#2563EB; text-transform:uppercase; letter-spacing:0.04em;">Systèmes de Gestion de Files d'Attente & Displays Médicaux</div>
              <div style="font-size:0.73rem; color:#64748B; margin-top:0.25rem; line-height:1.35;">
            ...
            <div style="text-align:right;">
              <div style="font-size:1.4rem; font-weight:900; color:#1E3A8A; letter-spacing:0.03em; text-transform:uppercase;">DEVIS</div>
              <div style="font-size:0.95rem; font-weight:800; color:#2563EB; margin-top:0.1rem;">#${q.id}</div>
              <div style="margin-top:0.35rem; background:#F0F7FF; border:1px solid #BFDBFE; padding:0.35rem 0.75rem; border-radius:6px; display:inline-block;">
                <div style="font-size:0.68rem; color:#1E40AF; font-weight:700;">DATE D'ÉMISSION</div>
                <div style="font-size:0.82rem; font-weight:800; color:#1F2937;">${todayStr}</div>
              </div>
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; margin-bottom:1rem; page-break-inside:avoid;">
            <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:10px; padding:0.75rem 1rem;">
              ...
              <div style="font-size:1.05rem; font-weight:800; color:#1F2937;">${q.client}</div>
              <div style="font-size:0.8rem; color:#475569; margin-top:0.15rem;">📍 ${q.city || 'Casablanca, Maroc'}</div>
              <div style="font-size:0.8rem; color:#475569; margin-top:0.1rem;">📞 ${q.phone || '+212 661-009988'}</div>
            </div>
            ...
            <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:10px; padding:0.75rem 1rem;">
              ...
              <div style="font-size:0.8rem; color:#475569; margin-top:0.15rem;">📧 ${state.currentUser.email}</div>
              <div style="font-size:0.73rem; color:#2563EB; font-weight:700; margin-top:0.15rem;">🛡️ Garantie Matérielle 12 Mois Incluses</div>
            </div>
          </div>
          ...
          <table style="width:100%; border-collapse:collapse; margin-bottom:1rem; font-size:0.82rem; page-break-inside:avoid;">
            <thead>
              <tr style="background:#F1F5F9; color:#334155; text-align:left; border:1px solid #CBD5E1;">
                <th style="padding:0.55rem 0.85rem; border-top-left-radius:6px; border-bottom-left-radius:6px; font-weight:800;">Désignation des Équipements & Prestations</th>
                <th style="padding:0.55rem 0.4rem; text-align:center; font-weight:800;">Qté</th>
                <th style="padding:0.55rem 0.65rem; text-align:right; font-weight:800;">P.U. HT</th>
                <th style="padding:0.55rem 0.4rem; text-align:center; font-weight:800;">TVA</th>
                <th style="padding:0.55rem 0.85rem; text-align:right; border-top-right-radius:6px; border-bottom-right-radius:6px; font-weight:800;">Total HT (MAD)</th>
              </tr>
            </thead>
            <tbody>
              <tr style="border-bottom:1px solid #E2E8F0;">
                <td style="padding:0.65rem 0.85rem;">
                  ...
                  <div style="font-size:0.75rem; color:#64748B; margin-top:0.15rem; line-height:1.35;">
                ...
                <td style="padding:0.65rem 0.4rem; text-align:center; font-weight:700;">1</td>
                <td style="padding:0.65rem 0.65rem; text-align:right; font-weight:700;">${totalHT.toLocaleString()}</td>
                <td style="padding:0.65rem 0.4rem; text-align:center; font-weight:600; color:#64748B;">20%</td>
                <td style="padding:0.65rem 0.85rem; text-align:right; font-weight:800; color:#1F2937;">${totalHT.toLocaleString()}</td>
              </tr>
              <tr style="border-bottom:1px solid #E2E8F0; background:#F8FAFC;">
                <td style="padding:0.55rem 0.85rem;">
                  <div style="font-weight:700; color:#334155; font-size:0.8rem;">🛡️ Pack Garantie & Support Technique Dédié</div>
                  <div style="font-size:0.73rem; color:#64748B; margin-top:0.1rem;">Support 7j/7, Échange Matériel à Neuf & Assistance à Distance</div>
                </td>
                <td style="padding:0.55rem 0.4rem; text-align:center; font-weight:700;">1</td>
                <td style="padding:0.55rem 0.65rem; text-align:right; font-weight:700; color:#16A34A;">Inclus</td>
                <td style="padding:0.55rem 0.4rem; text-align:center; font-weight:600;">20%</td>
                <td style="padding:0.55rem 0.85rem; text-align:right; font-weight:800; color:#16A34A;">0 MAD</td>
              </tr>
            </tbody>
          </table>

          <!-- Totals & Payment Conditions Block -->
          <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:1rem; page-break-inside:avoid;">
            <div style="width:54%; background:#F0F7FF; border:1px solid #BFDBFE; border-radius:10px; padding:0.85rem 1rem;">
              ...
              <div style="font-size:0.78rem; color:#1E3A8A; line-height:1.45;">
            ...
            <div style="width:42%; background:#F8FAFC; border:1px solid #CBD5E1; border-radius:10px; padding:0.85rem 1rem; text-align:right;">
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:0.65rem; margin-bottom:1rem; page-break-inside:avoid;">
            <div style="border:1px solid #E2E8F0; border-radius:8px; padding:0.5rem 0.65rem; text-align:center; background:#F8FAFC;">
              <div style="font-weight:800; font-size:0.78rem; color:#1F2937;">🛡️ Garantie 12 Mois</div>
              <div style="font-size:0.68rem; color:#64748B; margin-top:0.1rem;">Échange à neuf en cas de panne</div>
            </div>
            <div style="border:1px solid #E2E8F0; border-radius:8px; padding:0.5rem 0.65rem; text-align:center; background:#F8FAFC;">
              <div style="font-weight:800; font-size:0.78rem; color:#1F2937;">⚡ Installation Inclus</div>
              <div style="font-size:0.68rem; color:#64748B; margin-top:0.1rem;">Prise en charge technique complète</div>
            </div>
            <div style="border:1px solid #E2E8F0; border-radius:8px; padding:0.5rem 0.65rem; text-align:center; background:#F8FAFC;">
              <div style="font-weight:800; font-size:0.78rem; color:#1F2937;">🎓 Formation Personnel</div>
              <div style="font-size:0.68rem; color:#64748B; margin-top:0.1rem;">Support & assistance d'équipe</div>
            </div>
          </div>
        </div>
        ...
        <div style="display:flex; justify-content:space-between; align-items:flex-end; padding-top:0.75rem; border-top:1px dashed #CBD5E1; page-break-inside:avoid; break-inside:avoid;">
          <div style="width:47%; text-align:center; border:1px dashed #CBD5E1; border-radius:8px; padding:0.65rem; height:85px; display:flex; flex-direction:column; justify-content:space-between; box-sizing:border-box;">
            <div style="font-size:0.7rem; font-weight:800; color:#64748B; text-transform:uppercase;">BON POUR ACCORD & CACHET CLIENT</div>
            <div style="font-size:0.68rem; color:#94A3B8;">Mention "Lu et approuvé" + Signature</div>
          </div>

          <div style="width:47%; text-align:center; border:1px solid #BFDBFE; background:#F0F7FF; border-radius:8px; padding:0.65rem; height:85px; display:flex; flex-direction:column; justify-content:space-between; box-sizing:border-box;">
            <div style="font-size:0.7rem; font-weight:800; color:#1E40AF; text-transform:uppercase;">POUR ECOM ZEIN MAROC S.A.R.L</div>
            <div style="font-size:0.78rem; font-weight:800; color:#1E3A8A; letter-spacing:0.04em;">[ CACHET & SIGNATURE OFFICIELLE ]</div>
          </div>
        </div>
